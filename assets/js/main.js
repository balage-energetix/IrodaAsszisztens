...
const App = {
    ...
    injectGlobalNav() {
        ...
        const p = (window.location.pathname.includes('/modules/') || window.location.pathname.includes('/strategia/') || window.location.pathname.includes('/assets/')) ? (window.location.pathname.match(/\//g).length > 2 ? '../../' : '../') : '';
            ...
            <nav class="app-nav">
                <div class="nav-cat">ENERGETIKA <i class="fas fa-chevron-down ms-1" style="font-size:0.7rem;"></i>
                    <div class="nav-cat-dropdown">
                        <a href="${p}strategia/NAGYATÁD_GÁZ_DÖNTÉSTÁMOGATÓ_VÉGLEGES_UTÁNI2.html" class="nav-dropdown-item"><i class="fas fa-check-circle" style="color:#4caf50;"></i> Gáz Döntéstámogató (2026-2027)</a>
                        <a href="${p}strategia/NAGYATÁD GÁZPIACI STRATÉGIA - GRAFIKONOK.mhtml" target="_blank" class="nav-dropdown-item"><i class="fas fa-chart-area" style="color:#ff5722;"></i> Gázpiaci Stratégia - Grafikonok</a>
    ...
    checkLogin() {
        // Authentication removed - defaulting to Admin access
